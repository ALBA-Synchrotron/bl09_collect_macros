...
from collectlib.tomoslib_vdos import ManyTomos_vdos
...
class manytomosbase_vdos(object):
    ...
    def run(self, samples, filename):
        ...
        tomos_obj = ManyTomos_vdos(samples, filename)
        tomos_obj.generate()


class manytomos_vdos(manytomosbase_vdos, Macro):
